...
const routes = [
  ...
  {
    path: "/tournament/:tourId/playerArrangement",
    name: "Player Arrangement",
    component: () =>
      import("@/components/views/competitions/ViewPlayerArrangement.vue"),
  },
  {
    path: "/tournament/:tourId/playerArrangement/:compId",
    name: "Competition Player Arrangement",
    component: () =>
      import("@/components/views/competitions/ViewPlayerArrangement.vue"),
  },
];
