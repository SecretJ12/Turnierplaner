<template>
  ...
  <el-tabs v-model="currentTab" v-if="groupSystem !== undefined" style="width: 1000px;">
    <el-tab-pane label="Liste" name="list">
      <ViewGroupList v-for="group in groupSystem.groups" :key="group.index" :group="group"/>
    </el-tab-pane>
    <el-tab-pane label="Tabelle" name="table">
      <ViewGroupTable v-for="group in groupSystem.groups" :key="group.index" :group="group"/>
    </el-tab-pane>
    <el-tab-pane label="Tabelle V2" name="tablev2">
      <ViewGroupTableV2 class="table" v-for="group in groupSystem.groups" :key="group.index" :group="group"/>
    </el-tab-pane>
  </el-tabs>
</template>
