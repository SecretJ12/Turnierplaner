  ...
  <div id="container">
    ...
    <div id="content">
      <div id="competitions">
        ...
        <ItemPlayerArrangement v-if="canEdit" @selected="arrangePlayer" />
      </div>
      <el-steps
...
import ItemPlayerArrangement from "@/components/items/ItemPlayerArrangement.vue";
...
function arrangePlayer() {
  router.push({
    path: "/tournament/" + route.params.tourId + "/playerArrangement",
  });
}
