...
public class ConfigResource {
  ...
  public void saveConfig(jUserConfig nConfig) {
    ...
    if (nConfig.getLanguage() != null) config.setLanguage(nConfig.getLanguage());
  ...
  public void saveTitle(jUserConfig nConfig) {
    DefaultConfig defConfig = defaultConfigRepository.findById(0L);
    if (nConfig.getTitle() != null) defConfig.setTitle(nConfig.getTitle());
    else defConfig.setTitle("title");
