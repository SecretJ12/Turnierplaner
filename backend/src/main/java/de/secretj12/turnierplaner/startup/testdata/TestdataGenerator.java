...
public class TestdataGenerator {
    ...
    private void addCompetition(Tournament t, TDate tDate,
        ...
        for (CompetitionSettings compSetting : compList) {
            ...
            switch (tDate) {
                case BEFORE_REGISTRATION -> competition.setcProgress(CreationProgress.PLAYER);
                case REGISTRATION_OPEN, BEFORE_GAMEPHASE, GAMEPHASE_OPEN, AFTER_GAMEPHASE -> competition.setcProgress(
