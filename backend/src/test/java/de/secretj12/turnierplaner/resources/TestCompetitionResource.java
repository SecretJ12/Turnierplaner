...
public class TestCompetitionResource {
  ...
  public void getAllCompetitonsUnauthorized() {
    given()
        ...
        .body("$.size()", is(1), "[0].name", is("Herren"));
  }
  ...
  public void getAllCompetitonsAuthorized() {
    given()
        ...
        .statusCode(200)
        .contentType(MediaType.APPLICATION_JSON)
        .body("$.size()", is(1), "[0].name", is("Damen"));
  }
  ...
  public void getPrepareCompetitions() {
    given()
        ...
        .body(
            ...
            is("Herren"),
            "[0].id",
            is(competitions.getByName("Clubmeisterschaft 2021", "Herren").getId().toString()));
  }
  ...
  public void getCompetition() {
    given()
        ...
        .statusCode(200)
        .contentType(MediaType.APPLICATION_JSON)
        .body("name", is("Herren"), "id", notNullValue());
  }
  ...
  public void getCompetitionUnauthorized() {
    given()
        ...
        .statusCode(200)
        .contentType(MediaType.APPLICATION_JSON)
        .body("name", is("Herren"), "id", nullValue());
  }
    ...
    given()
        ...
        .body(
            String.format(
                ...
                """,
                competitions.getByName("Clubmeisterschaft 2021", "Herren").getId().toString()))
  ...
  public void getSignedUpPlayers() {
    given()
        ...
        .statusCode(200)
        .contentType(MediaType.APPLICATION_JSON)
        .body("$.size()", is(1), "[0].playerA.firstName", is("Rainer"));
  }
  ...
  public void getSignedUpPlayersOutdatedAuthorized() {
    ...
    given()
        ...
        .statusCode(200)
        .contentType(MediaType.APPLICATION_JSON)
        .body("$.size()", is(1), "[0].playerA.firstName", is("Anna"));
  }
  ...
  public void updateTeamsChangeTeams() {
    Player playerF = players.getByName("Anna", "Gramm");
    UUID teamIdBefore =
        competitions.getByName("Clubmeisterschaft 2021", "Herren").getTeams().getFirst().getId();
