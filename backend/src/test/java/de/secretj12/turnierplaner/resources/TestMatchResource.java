...
public class TestMatchResource {
  ...
  private final Instant endE =
      Instant.now().truncatedTo(ChronoUnit.SECONDS).plus(90, ChronoUnit.MINUTES);
  private final Instant beginF =
      Instant.now().truncatedTo(ChronoUnit.SECONDS).plus(90, ChronoUnit.MINUTES);
  private final Instant endF =
      Instant.now().truncatedTo(ChronoUnit.SECONDS).plus(180, ChronoUnit.MINUTES);
